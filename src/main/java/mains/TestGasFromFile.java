...
public class TestGasFromFile {
    public static void main(String[] args) throws IOException {
        ...
        MaxFlowResponse maxFlowResponse0 = FordFulkersonUtil.maxFlow(graph, 0, 10);
        System.out.println("Max Flow: " + maxFlowResponse0.getMaxFlow());
        ...
        Integer idSource = augmentedGraph.getVirtualSource().getId();
