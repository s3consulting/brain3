...
*/
        ...
        for (int iter = 0; iter < iterations; iter++) {
            ...
            if (confs.contains(ConfigurationConstant.HEAVY_FAULTS) && confs.contains(ConfigurationConstant.MILD_ATTACKS)) {
                GenericAnnualSimulator_ALGORITMO2 simulator_Intrinsic_Heavy_Faults_Mild_Attacks = new GenericAnnualSimulator_ALGORITMO2(dir,
                        graphName,
            ...
            if (confs.contains(ConfigurationConstant.HEAVY_FAULTS) && confs.contains(ConfigurationConstant.MEDIUM_ATTACKS)) {
                ...
                GenericAnnualSimulator_ALGORITMO2 simulator_Intrinsic_Heavy_Faults_Medium_Attacks = new GenericAnnualSimulator_ALGORITMO2(dir,
                        graphName,
            ...
            if (confs.contains(ConfigurationConstant.HEAVY_FAULTS) && confs.contains(ConfigurationConstant.HEAVY_ATTACKS)) {
                ...
                GenericAnnualSimulator_ALGORITMO2 simulator_Intrinsic_Heavy_Faults_Heavy_Attacks = new GenericAnnualSimulator_ALGORITMO2(dir,
                        graphName,
