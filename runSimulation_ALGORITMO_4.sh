...
#java -cp ./target/brain3Simulator-jar-with-dependencies.jar finale.RunGenericAnnualSimulator_ALGORITMO4 GRAPH_DIR GRAPH_FILE_NAME OUTPUT_DIR ATTACK_DIR HEAVY_FAULT_DIR ITERATIONS CONFIGURATION
